...
namespace PasswordValidation
{
    ...
    {
        public short minCharacters { get; set; }
        public short maxCharacters { get; set; }
        public char charcarter { get; set; }
    ...
    internal static class Puzzle
    {
        ...
        internal static List<Password> GetPasswords()
        {
            ...
            foreach (string s in GetPuzzleInput())
            {
                password = new Password();
                password.password = s.Split(':')[1].Trim();
                password.charcarter = s.Split(':')[0].Split(' ')[1].Trim().ToCharArray()[0];
                password.minCharacters = Convert.ToInt16(s.Split(' ')[0].Split('-')[0]);
                password.maxCharacters = Convert.ToInt16(s.Split(' ')[0].Split('-')[1]);
